        ...
        <div className="flex items-center justify-between px-3.5 py-2.5">
          ...
          <div className="relative">
            <button
              ...
              className="rounded-md p-1 text-[#a8a8b4] transition-colors hover:bg-gray-100 hover:text-[#60606a]"
            >
            ...
            {menuOpen && (
              <div
                ref={menuRef}
                className="absolute right-0 top-full z-30 mt-1 w-44 rounded-xl border border-[#e6e6eb] bg-white py-1 shadow-lg"
              >
                <button
                  onClick={() => { setCollapsed((c) => !c); setMenuOpen(false); }}
                  className="flex w-full items-center gap-2 px-3 py-2 text-sm text-[#18181b] hover:bg-[#f4f4f6]"
                >
                  <svg className="h-4 w-4 text-[#60606a]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    {collapsed ? (
        ...
        >
          ...
          {onAddProject && (
            <button
              ...
              className="flex items-center justify-center gap-1.5 rounded-lg border-2 border-dashed border-[#e6e6eb] py-3 text-xs font-medium text-[#a8a8b4] transition-colors hover:border-blue-400 hover:text-blue-600"
            >
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" />
              </svg>

      ...
      <header className="shrink-0 border-b border-[var(--border)] bg-[var(--surface-card)] px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <h1 className="text-xl font-bold text-[var(--text-primary)]">Estimates</h1>
            {!loading && (
        ...
        {!loading && !error && (
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            ...
            <div className="rounded-xl border border-[var(--border)] bg-[var(--surface-card)] p-4">
              ...
              <p className="mt-1 font-mono text-2xl font-bold text-[var(--text-primary)]">{formatCurrency(pendingTotal)}</p>
            </div>
            <div className="rounded-xl border border-[var(--border)] bg-[var(--surface-card)] p-4">
              <p className="text-xs text-[var(--text-muted)]">Accepted Value</p>
              <p className="mt-1 font-mono text-2xl font-bold text-emerald-600">{formatCurrency(acceptedTotal)}</p>
            </div>
          </div>
        )}

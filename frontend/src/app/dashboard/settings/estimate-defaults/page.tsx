        ...
        {showForm && (
          <div className="rounded-xl border border-[var(--border)] bg-[var(--surface-card)] p-5">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                <label className="mb-1 block text-xs font-medium text-[var(--text-muted)]">Job Type</label>
                <Select
                  value={form.job_type || ''}
              ...
              <div>
                <label className="mb-1 block text-xs font-medium text-[var(--text-muted)]">Wrap Coverage</label>
                <Select
              ...
              <div>
                <label className="mb-1 block text-xs font-medium text-[var(--text-muted)]">Vehicle Type</label>
                <Select

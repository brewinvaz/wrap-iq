                ...
                >
                  <div className="flex items-center gap-4 min-w-0">
                    <div className="shrink-0">
                      <svg
                        className={`h-4 w-4 text-[var(--text-secondary)] transition-transform ${isExpanded ? 'rotate-90' : ''}`}
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        strokeWidth={2}
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="mt-0.5 text-xs text-[var(--text-secondary)]">{brief.client}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 shrink-0">
                    <span
                      className={`rounded-full px-2.5 py-0.5 text-xs font-medium ${STATUS_STYLES[brief.status] ?? 'bg-[var(--surface-raised)] text-[var(--text-secondary)]'}`}
                    >
                      {brief.status}
                    </span>
                    <span className="font-mono text-xs text-[var(--text-secondary)]">Due {brief.dueDate}</span>
                  </div>
                </button>
                ...
                {isExpanded && (
                  <div className="border-t border-[var(--border)] bg-[var(--surface-raised)] px-5 py-4">
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                      <div>
                        <p className="font-mono text-[9.5px] uppercase tracking-wider text-[var(--text-secondary)]">
                          Vehicle / Surface
                        </p>
